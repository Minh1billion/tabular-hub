...
function FeatureCard({ title, description }: { title: string; description: string }) {
  return (
    <Card className="border-[1.5px] !border-[#ddddc4] hover:border-[#ddddc4]">
        ...
        <div className="relative grid lg:grid-cols-[1.05fr,1fr] gap-14 items-center">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-10">
              <Link
                to={primaryHref}
                className="inline-flex items-center justify-center px-5 py-3 rounded-xl text-sm font-medium bg-brand text-white border-[1.5px] border-[#ddddc4] hover:bg-brand-hover transition-colors active:scale-[0.98]"
              >
                {primaryLabel}
              </Link>
              <a
